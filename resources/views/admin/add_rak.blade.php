                                ...
                                <div class="card-body">
                                    <form action="{{ route('storage.store') }}" method="POST"
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="{{ route('storage.index') }}" class="btn btn-secondary me-2">Batal</a>
